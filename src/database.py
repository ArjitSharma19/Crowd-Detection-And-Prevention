...
async def init_db(default_admin_password_hash: str):
    ...
    Fails gracefully if MongoDB connection is delayed or unavailable.
    """
    try:
        ...
        print(f"Database: Warning - MongoDB connection error during startup ({e}). Continuing in standalone mode.")
